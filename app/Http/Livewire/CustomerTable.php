    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('firstname_lower', function (Customer $model) {
                return strtolower(e($model->firstname));
            })
    ...
    public function actions(): array
    {
        return [
            ...
            Button::make('destroy', 'Delete')
                ...
                ->target('')
                // ->bladeComponent('livewire.delete', ['customer' => 'id'])
                // ->bladeComponent('tambah')
                ->route('hapus', ['customer' => 'id'])
                ->method('delete'),
        ];
    }
